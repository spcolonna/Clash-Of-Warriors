...
final StoryArc _actoI = StoryArc(
  ...
  stages: [
    dialogue(0, 'La Montaña Sagrada', locationId: 'montana_sagrada', [
      ...
      narrator(
          'Puo Liu bajó la montaña y entró a La Ciudadela al caer la tarde. En el primer callejón, un Pendenciero del Puerto le cerró el paso: acá nadie camina hacia la Arena sin pagar peaje.'),
    ]),
    ...
    dialogue(4, 'El Mercado Subterráneo', locationId: 'catacumbas', [
      ...
      line('lugarteniente', 'El Lugarteniente',
          'Hasta acá llegaron los dos. El Mercado tiene dueño, y el torneo también.',
          sfx: '¡FSSS!'),
      line('puo_liu', 'Puo Liu',
          'Un lugarteniente. Entonces arriba tuyo hay alguien que da las órdenes.',
  ...
  stages: [
    dialogue(0, 'La Montaña Sagrada', locationId: 'montana_sagrada', [
      ...
      line('puo_liu', 'Puo Liu', 'Entonces lo voy a encontrar.',
          left: false, emotion: 'determined'),
      narrator(
          'No llegó ni al primer recodo del sendero. Un Sicario del Clan lo esperaba en el único descenso de la montaña: el Lugarteniente ya sabía que lo estaban cazando.'),
    ]),
    ...
    dialogue(2, 'Las Calles de La Ciudadela', locationId: 'ciudadela_calles', [
      ...
      narrator(
          'La dirección llevaba a una subasta clandestina bajo el Mercado. En la puerta, el Guardaespaldas del Mercado ya tenía las manos vendadas: la compradora de los archivos no interrumpe una venta por un monje.'),
    ]),
    ...
    dialogue(4, 'El Mercado Subterráneo', locationId: 'catacumbas', [
      ...
      narrator(
          'El rastro terminaba en un taller sin cartel. Adentro, El Falsificador imprimía los nombres que faltaban en la lista — y no pensaba dejar entrar a nadie que supiera leerlos.'),
    ]),
    ...
    dialogue(6, 'El Puerto de La Ciudadela', locationId: 'puerto', [
      ...
      line('puo_liu', 'Puo Liu',
          ...
          left: false, emotion: 'determined'),
      narrator(
          'El muelle estaba cerrado por dentro. El Capataz del Muelle acomodó a sus estibadores en fila entre Puo Liu y la pasarela: nadie sube a ese barco antes de que zarpe.'),
    ]),
  ...
  stages: [
    dialogue(0, 'El Templo Shaolin', locationId: 'montana_sagrada', [
      ...
      line('maestro_lin', 'Maestro Lin',
          ...
          emotion: 'sad'),
      narrator(
          'Con la carta en el pecho, Puo Liu tomó el camino a la ciudad. A media bajada lo esperaba un Asesor de Seguridad del Nuevo Consejo: credencial nueva, modales de Clan.'),
    ]),
    ...
    dialogue(2, 'La Plaza de la Arena', locationId: 'arena', [
      ...
      line('verdugo', 'El Verdugo del Consejo',
          'Los que saben leer ese sello no llegan a contarlo. Nunca falla.',
          emotion: 'angry', sfx: '¡CLANG!'),
      line('puo_liu', 'Puo Liu',
          'El Verdugo. Mandan al que calla testigos... entonces vamos por buen camino.',
          left: false, emotion: 'determined'),
    ]),
    ...
    dialogue(4, 'La Imprenta Clandestina', locationId: 'catacumbas', [
      ...
      line('puo_liu', 'Puo Liu', 'Vos fabricaste la fachada del Nuevo Consejo.',
          left: false),
      line('falsario', 'El Falsario',
          'Fabriqué una obra de arte. Cada papel del Nuevo Consejo es perfecto. Excepto uno que no escribí yo...',
          bubble: BubbleType.whisper),
    ...
    dialogue(6, 'El Tejado de la Federación', locationId: 'ciudadela_calles', [
      ...
      line('campeon_cristal', 'El Campeón de Cristal',
          'Al estrado se sube por el ring, monje. Y el ring esta noche es mío.',
          bubble: BubbleType.shout),
      line('puo_liu', 'Puo Liu',
          'Un campeón fabricado, como todo lo que armaron. Se rompe igual.',
          left: false),
    ]),
  ...
  stages: [
    dialogue(0, 'La Montaña Sagrada, de noche', locationId: 'montana_sagrada', [
      ...
      line('puo_liu', 'Puo Liu', 'Yo llevo la verdad hasta el centro del ring.',
          left: false),
      narrator(
          'La Vanguardia del Asedio ya había tomado el sendero: si el Templo '
          'quería bajar a la Arena, tenía que abrirse paso a golpes desde el '
          'primer metro.'),
    ]),
    ...
    dialogue(2, 'Las Calles en Llamas', locationId: 'ciudadela_calles', [
      ...
      line('puo_liu', 'Puo Liu',
          ...
          left: false, sfx: '¡TUMP!'),
      line('verdugo', 'El Verdugo',
          'Sin traje, sin credencial, sin testigos. Así trabajaba antes, monje.',
          emotion: 'angry'),
      line('puo_liu', 'Puo Liu',
          'El Verdugo otra vez. Ya sin disfraz: hoy nadie finge nada.',
          left: false),
    ]),
    ...
    dialogue(4, 'Las Puertas de la Arena', locationId: 'arena', [
      ...
      line('puo_liu', 'Puo Liu', 'No... esa conversación es una trampa.',
          left: false, emotion: 'angry', bubble: BubbleType.shout),
      narrator(
          'Corrió hacia el túnel del ring. La Guardia del Arquitecto cerró la boca del pasillo en bloque: los últimos que le quedaban a Wen, y lo sabían.'),
    ]),
    ...
    dialogue(6, 'El Corazón de la Arena', locationId: 'arena', [
      ...
      line('arquitecto', 'El Arquitecto',
          ...
          bubble: BubbleType.whisper),
      line('arquitecto', 'El Arquitecto',
          'Pero a mí se llega por el ring. Primero mi Campeón del Último Torneo. Ganátelo, si podés.',
          sfx: '¡GONG!'),
    ]),
